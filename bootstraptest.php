...
<div class="select_area">
  ...
  <section class="gallery-block cards-gallery">
    <div class="container">
      <div class="row">
        <div class="col-12 align-self-center" style="margin-top:10px; margin-bottom:10px">
          <div class="card border-0 transform-on-hover">
            <a class="lightbox" href="images/F1.jpg"><img src="56738.jpg" class="card-img-top" style="height:250px; object-fit:cover"></a>
            <div class="card-body">
              <h6>Lorem Ipsum</h6>
    ...
    <div class="row">
      <div class="col-md-4" style="background-color: white;">
        <div class="container">
          <div class="row">
            <div class="col-md-11" style="float: none; margin-right: auto;margin-left: auto; margin-top: 10px; margin-bottom:10px box-sizing:border-box;">
              <div class="card border-0 transform-on-hover" style="margin-top: 10px; margin-bottom:10px box-sizing:border-box;">
                <a class="lightbox" href="images/F1.jpg"><img src="56738.jpg" class="card-img-top" style="height:250px; object-fit:cover"></a>
                <div class="card-body">
                  <h6>Lorem Ipsum</h6>
                  <p class="text-muted card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna.</p>
